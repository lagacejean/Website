<div class="box">
  ...
  <ul>
	...
	Comment vais-je obtenir du financement pour mes dépenses dues
	au CCÉM?
      </a>
    </li>
    <li>
	...
	Je souhaite donner une conférence, de quoi devrais-je parler?
      </a>
    </li>
    <li>
      <a href="#not-expert">
	...
	Je suis très nerveux, c'est la première fois que je donne une
	conférence, que me conseillez-vous?
      </a>
    </li>
    <li>
      <a href="#same-time">
	Il y a deux conférences auxquels j'aimerais assiter qui se
...
<div class="box">
  <div class="question-first" id="funding-myself">
    <p>
      Q: Comment vais-je obtenir du financement pour mes dépenses dues
      au CCÉM?
    </p>
  </div>
  ...
  <div class="answer">
    <p>
      ...
      d'amoureux des mathématiques de partout au Canada, et même
  ...
  <div class="question" id="half-present">
    <p>
      Q: Je ne peux pas être présent pour la totalité du
      congrès. Devrais-je quand même venir pour une partie de
      celui-ci?
    </p>
  </div>
  ...
  <div class="answer">
    <p>
      ...
      donner dans une langue et de préparter les diapositives dans
      l'autre. Il est aussi possible de mentionner à l'auditoire que
  ...
  <div class="question" id="same-time">
    <p>
      Q: Il y a deux conférences auxquels j'aimerais assiter qui se
      donnent en même temps.
    </p>
  </div>
